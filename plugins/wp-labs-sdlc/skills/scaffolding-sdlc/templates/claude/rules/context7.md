---
alwaysApply: true
description: Instructs Claude to fetch live library docs via npx ctx7@latest before answering questions about any library, framework, SDK, API, or CLI tool
---
